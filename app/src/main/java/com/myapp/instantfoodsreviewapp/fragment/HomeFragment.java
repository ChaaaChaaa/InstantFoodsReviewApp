...
public class HomeFragment extends Fragment implements View.OnClickListener {
    ...
    public void onClick(View view) {
        if (view == fragmentHomeBinding.imageColdNoodle) {
            FragmentTransaction fragmentTransactionNoodle = getParentFragmentManager().beginTransaction();
            ...
            FragmentTransaction fragmentTransactionddok = getParentFragmentManager().beginTransaction();
            ...
            FragmentTransaction fragmentTransactionDumpling = getParentFragmentManager().beginTransaction();
            ...
            FragmentTransaction fragmentTransactionFriedRice = getParentFragmentManager().beginTransaction();
            ...
            FragmentTransaction fragmentTransactionPizza = getParentFragmentManager().beginTransaction();
            ...
            FragmentTransaction fragmentTransactionStew = getParentFragmentManager().beginTransaction();
